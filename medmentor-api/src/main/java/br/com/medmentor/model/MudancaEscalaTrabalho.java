...
public class MudancaEscalaTrabalho implements Serializable {
    ...
    public MudancaEscalaTrabalho() {
    	
    }

    public MudancaEscalaTrabalho(Integer idMudancaEscalaTrabalho, Integer idEscalaTrabalho, LocalDateTime dataHoraSolicitacao, LocalDateTime dataHoraMudanca, Integer idEmpresaProfissionalUnidadeGestaoAnterior, Integer idEmpresaProfissionalUnidadeGestaoAtual) {
