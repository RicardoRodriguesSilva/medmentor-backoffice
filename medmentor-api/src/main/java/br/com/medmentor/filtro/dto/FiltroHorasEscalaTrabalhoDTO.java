...
public class FiltroHorasEscalaTrabalhoDTO extends GenericDTO {
	...
	public String toString() {
		return "FiltroHorasTrabalhadasDTO [idProfissional=" + idProfissional + ", idGestoraSaude=" + idGestoraSaude
